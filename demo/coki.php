<?php
$cnn=mysqli_connect('localhost','root','','utsav_db')or die("not connected");
?>
<form action="coooki2.php" method="post" style="border: 2px dotted blue; text-align:center; width: 400px;">
	<p>
